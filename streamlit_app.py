...
def main():
    ...
    uploaded_file = st.sidebar.file_uploader(
        "Upload your adoption data CSV file",
        type=['csv'],
        help="CSV should have columns: Outcome, AnimalNumber, Species, DateTime"
    )
    ...
    if uploaded_file is not None:
        try:
            ...
            forecast = AdoptionForecast("temp_data.csv")
        ...
        sample_data = {
            'Outcome': ['Adoption', 'Adoption', 'Adoption'],
            'AnimalNumber': ['A001', 'A002', 'A003'],
            'Species': ['Dog', 'Cat', 'Dog'],
            'DateTime': ['6/26/24 8:34', '6/26/24 14:22', '6/27/24 10:15']
        }
        ...
        st.markdown("""
        ### 📝 Instructions:
        1. Upload a CSV file with adoption data
        2. Configure your settings in the sidebar
        3. Explore the different analysis tabs
        4. Review counselor workload and capacity analysis
        """)
